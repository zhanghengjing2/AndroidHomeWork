...
public class MainScreen extends AppCompatActivity  {
    ...
    //private Button btn_order,btn_show;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DishList dlist = MyApplication.getInstance().getFullListFromJson();



        /*
        btn_order=(Button)findViewById(R.id.btn_order);
        btn_show=(Button)findViewById(R.id.btn_showorder);
    ...
    private void ShowGridView() {
        ...
        try
        {
            ...
            if(!sID.isEmpty())
            {
                if(sID.equals("FromEntry")||sp.getInt("loginState",0)==1)
                {
                    for (int i = 0; i < 2; i++) {
